...
module "opensearch-secuity-group" {
  ...
  computed_ingress_with_source_security_group_id = [
...

    {
      ...
      source_security_group_id = [module.opensearch-secuity-group.security_group_id][0]
    },
    {
      from_port                = 9200
      to_port                  = 9200
      protocol                 = 6
      description              = "Eks Allowed for ElasticSearch"
      source_security_group_id = [module.eks.worker_security_group_id][0]
    },
